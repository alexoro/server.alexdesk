...
var preparedCreateAppUser =
    'UPDATE public.app_users SET login = $1, password_hash = $2, name = $3, registered = $4, last_visit = $5 WHERE app_user_id = $6';
...
var preparedAppUserCreateExtra = 'UPDATE public.app_users_extra_android SET device_uuid = $1, gcm_token = $2 WHERE app_user_id = $3';
