...
var preparedSet = 'INSERT INTO public.system_access_tokens(id, user_type, user_id, expires) VALUES($1, $2, $3, $4)';

var fnSetAndGenerateResult = function (flow, cb) {
    flow.client.query(preparedSet, [flow.args.token, flow.args.userType, flow.args.userId, flow.args.expires], function (err, result) {
        if (err) {
